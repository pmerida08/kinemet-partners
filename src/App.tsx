...
export default function App() {
  ...
  return (
    <>
      {showWorkerPortal && (
        <WorkerPortal onClose={() => setShowWorkerPortal(false)} />
      )}
          ...
          <div className="max-w-7xl mx-auto">
            <div className="max-w-[800px] mb-10 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-slate-600 leading-relaxed">
                Inyectamos movimiento para generar transformación real en
                empresas y personas. Resolvemos problemas complejos de
                transformación de negocio uniendo el mundo de los{" "}
            ...
            <div className="grid sm:grid-cols-2 gap-5 mb-8 sm:mb-12">
              ...
              <div className="p-8 sm:p-10 rounded-2xl bg-white shadow-sm border border-slate-100 hover:shadow-md transition-shadow">
                ...
                <p className="text-slate-600 leading-relaxed text-sm sm:text-base">
                  ...
                  Transformamos estructuras y mentalidades para que el
            ...
            <div className="grid sm:grid-cols-2 gap-8 sm:gap-12">
              <div className="border-t-2 border-accent pt-7 sm:pt-8">
                ...
                <p className="text-slate-600 leading-relaxed text-sm sm:text-base">
                  Servicios de consultoría altamente personalizados para
                  proyectos complejos que requieren un enfoque único y profundo
              ...
              <div className="border-t-2 border-accent pt-7 sm:pt-8">
                ...
                <p className="text-slate-600 leading-relaxed text-sm sm:text-base">
                  Soluciones digitales estandarizadas, repetibles y escalables
                  que permiten democratizar la transformación y acelerar el
                  aprendizaje.
                </p>
              </div>
            </div>
            ...
            <div className="text-center mb-12 sm:mb-20">
              ...
              <p className="text-base sm:text-xl text-slate-600 max-w-[800px] mx-auto mb-6 sm:mb-8 leading-relaxed">
                ...
                <strong className="text-primary">
                  Colectivo de Consultoría
                </strong>
                : una red de profesionales independientes y multidisciplinares
                de alto nivel que ofrece impacto directo sin estructuras
                rígidas.
              </p>
              <div className="inline-flex items-center gap-2 bg-accent/10 text-accent px-5 sm:px-6 py-3 rounded-full font-bold text-xs sm:text-sm uppercase tracking-wider">
                <ShieldCheck size={18} />
                Seniority Garantizado: +20-25 años de experiencia corporativa
                real
              </div>
            </div>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10 sm:mb-16">
              ...
              <p className="text-base sm:text-lg text-slate-600">
                ¿Listo para impulsar el movimiento en su organización? Creemos
                la transformación juntos.
              </p>
            </div>
